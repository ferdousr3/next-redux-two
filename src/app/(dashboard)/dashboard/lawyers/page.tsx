...
import { fetchLawyers, createLawyer, updateLawyer, deleteLawyer, clearError } from '@/lib/features/lawyers/slice'
...
export default function LawyersManagement() {
   ...
   const resetForm = () => {
      setFormData({ name: '', email: '', phoneNumber: '', lawyerType: '', instituteName: '', address: '', practiceStartYear: '' })
   }
   ...
   const handleEdit = (lawyer: Lawyer) => {
      ...
      setFormData({
         ...
         practiceStartYear: lawyer.practiceStartYear ? new Date(lawyer.practiceStartYear).getFullYear().toString() : '',
      })
      setIsOpen(true)
   }
                           ...
                           <div>
                            ...
                            <div>
                              ...
                              <Input
                                 ...
                                 onChange={(e) => setFormData({ ...formData, practiceStartYear: e.target.value })}
                                 placeholder="YYYY"
                              />
                           </div>
                        </div>
