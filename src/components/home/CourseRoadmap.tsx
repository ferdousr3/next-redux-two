...
export function CourseRoadmap() {
  return (
    <section className="bg-slate-50 py-24 border-t border-slate-100 mb-32">
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="relative">
                ...
                <div className="flex justify-center mt-16">
                     <div className="inline-flex items-center gap-2 px-6 py-2 bg-slate-900 text-white rounded-full text-sm font-bold shadow-lg">
